 ...
 * In this version, the KeyListener is implemented as an anonymous class 
 * This class draws a circle which can be moved with the key: up,down,left, right. 
 */

public class MoveCircleAnonymous extends JPanel {
	...
	public MoveCircleAnonymous() {
		...
		addKeyListener(new KeyListener() { // anonymous class
			/*
			 * This method belongs to the KeyListener interface. It handles the
			 * keyPressed events. If the key: up/down/left or right is pressed,
			 * the x or y coordinates are changed and the circle is repainted.
			 * That way is the movement effect accomplished
			 */
		...
		}); // and of the anonymous class KeyListener
	}
	...
	public static void main(String[] args) {
		...
		MoveCircleAnonymous content = new MoveCircleAnonymous();
