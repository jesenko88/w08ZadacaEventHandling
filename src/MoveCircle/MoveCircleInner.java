 ...
 * In this version, there is an inner class which implements the KeyListener Interface 
 * This class draws a circle which can be moved with the key: up,down,left, right. 
 */
public class MoveCircleInner extends JPanel {
	...
	public static void main(String[] args) {
		...
		MoveCircleInner content = new MoveCircleInner();
